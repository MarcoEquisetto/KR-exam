...
\title{
    ...
    \vspace{0.5cm}
    \Large Knowledge Representation \& Reasoning Report
    \vspace{1.5cm}
}
\author{\textbf{Ontology Development Team} \\ University / Department Name}
\date{\today}
...
% -------------------------------------------------------------------
\begin{abstract}
\noindent This report documents the design, implementation, and validation of a semantic ontology for the Clinical Healthcare domain. Developed using OWL 2 DL (Web Ontology Language), the system models complex hospital environments, including staff hierarchies, patient care workflows, and surgical requirements. 
